...
function connected(jsn) {
  console.log("covalent plugin connected")
    /** subscribe to the willAppear and other events */
    $SD.on('com.chadbailey.covalent.action.willAppear', (jsonObj) => action.onWillAppear(jsonObj));
    $SD.on('com.chadbailey.covalent.action.keyUp', (jsonObj) => action.onKeyUp(jsonObj));
    $SD.on('com.chadbailey.covalent.action.sendToPlugin', (jsonObj) => action.onSendToPlugin(jsonObj));
    $SD.on('com.chadbailey.covalent.action.didReceiveSettings', (jsonObj) => action.onDidReceiveSettings(jsonObj));
    $SD.on('com.chadbailey.covalent.action.propertyInspectorDidAppear', (jsonObj) => {
        console.log('%c%s', 'color: white; background: black; font-size: 13px;', '[app.js]propertyInspectorDidAppear:');
    });
    $SD.on('com.chadbailey.covalent.action.propertyInspectorDidDisappear', (jsonObj) => {
